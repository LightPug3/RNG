     ...
     <v-container class="container">
        <v-row class="row bg-surfaceVariant" justify="center">
            <v-col class="col col1" align="center">
                <v-card title="LED A" width="150" density="compact"  border rounded="md" flat>   
                     <v-divider></v-divider>
                     <v-card-item>     
            ...
            <v-col class="col col2" align="center">
                <v-card title="LED B" width="150" density="compact"  border rounded="md" flat>   
                    <v-divider></v-divider>
                    <v-card-item>     
...
const toggle = (name) => {
    ...
    Mqtt.publish("620156694_sub",message);                          // Publish message to appropriate topic  
}
